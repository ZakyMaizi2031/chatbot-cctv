        ...
        <aside className="w-full lg:w-64 flex-shrink-0">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sticky top-28">
            ...
            <div className="flex flex-col gap-1.5">
              <Link href="?tab=dashboard" className={`flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-300 ${tab === 'dashboard' ? 'bg-blue-50 text-blue-700 shadow-sm border border-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-800'}`}>
                <div className={`p-1.5 rounded-lg ${tab === 'dashboard' ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-400'}`}>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-6 border-b border-slate-100 bg-slate-50/50">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Analisis data kamera yang paling sering terputus (offline) dalam sistem.
                  </p>
                </div>
