        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50 text-slate-500 text-xs font-semibold uppercase tracking-wider border-b border-slate-100">
              ...
              <th className="py-3 px-6 text-right w-24">Aksi</th>
            </tr>
          </thead>
              ...
              <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className="py-4 px-6 text-right">
                  <button 
                    ...
                    className="p-2 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-30 disabled:hover:text-slate-400 disabled:hover:bg-transparent"
                    title={user.email === currentUserEmail ? "Tidak dapat menghapus akun sendiri" : "Hapus Akses"}
                  >
